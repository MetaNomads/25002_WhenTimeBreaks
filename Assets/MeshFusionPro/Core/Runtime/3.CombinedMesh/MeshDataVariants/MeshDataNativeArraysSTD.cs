...
namespace NGS.MeshFusionPro
{
    public class MeshDataNativeArraysSTD : CombinedMeshDataInternal
    {
        ...
        { 
            get 
            { 
                return UnityAPI.NativeListToArray(_vertices); 
            } 
        }
        ...
        { 
            get 
            { 
                return UnityAPI.NativeListToArray(_normals); 
            } 
        }
        ...
        { 
            get 
            { 
                return UnityAPI.NativeListToArray(_tangents); 
            } 
        }
        public NativeArray<Bounds> PartsBounds 
        { 
            get 
            { 
                return UnityAPI.NativeListToArray(_partsBounds); 
            } 
        }
        public NativeArray<Bounds> PartsBoundsLocal 
        { 
            get 
            { 
                return UnityAPI.NativeListToArray(_partsBoundsLocal); 
            } 
        }
        ...
        protected override void OnMeshUpdated()
        {
            ...
            using (var meshDataArray = Mesh.AcquireReadOnlyMeshData(mesh))
            {
                ...
                meshData.GetVertices(UnityAPI.NativeListToArray(_vertices));
                meshData.GetNormals(UnityAPI.NativeListToArray(_normals));
                meshData.GetTangents(UnityAPI.NativeListToArray(_tangents));
            }
