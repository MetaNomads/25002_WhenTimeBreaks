...
namespace NGS.MeshFusionPro
{
    public partial class SelectionTool
    {
            ...
            where TMeshFusionSource : MeshFusionSource
        {
            ...
            {
                GameObject[] gos = UnityAPI.FindObjectsOfType<GameObject>();
        ...
        private class StaticSourcesSelector : BaseSourcesSelector<StaticMeshFusionSource>
        {
            ...
            protected override void DrawContent(ref bool sceneChanged)
            {
                ...
                {
                    AssignToGameObjects(go => GameObjectsFilter(go, _assignOnlyStatic));
                    sceneChanged = true;
                }
        ...
        private class SkinnedSourcesSelector : BaseSourcesSelector<SkinnedMeshFusionSource>
        {
            public override bool isAvailable
            {
                get
            ...
            public SkinnedSourcesSelector(SelectionTool parent) 
                : base (parent)
            {
                GizmoColor = Color.blue;
                Label = "Skinned Sources";
            }
            ...
            protected override void DrawContent(ref bool sceneChanged)
            {
                ...
                if (GUILayout.Button("Assign Auto", ButtonGUIStyle))
                {
                    AssignToGameObjects(go => Filter(go));
                    sceneChanged = true;
                }
                GUI.backgroundColor = backColor;
                ...
                if (GUILayout.Button("Assign Selected", ButtonGUIStyle))
                {
                    AssignToSelectedGameObjects(go => Filter(go));
                    sceneChanged = true;
                }
            ...
            private bool Filter(GameObject go)
            {
                ...
                if (!go.TryGetComponent(out SkinnedMeshRenderer renderer))
                    return false;
