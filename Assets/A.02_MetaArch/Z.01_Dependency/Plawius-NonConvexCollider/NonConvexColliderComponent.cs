...
namespace Plawius.NonConvexCollider
{
    ...
    {
        public DecompositionAlgorithm Algorithm = DecompositionAlgorithm.VHACD;

        // Common parameters shared by all algorithms
        public CommonParameters CommonParams = CommonParameters.Default();

        // Algorithm-specific parameters
        public Parameters Params = Parameters.Default();
        public CoACDParameters CoACDParams = CoACDParameters.Default();
